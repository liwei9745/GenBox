(function (global) {
  ...
  var MESSAGES = {
    ...
    "extensions.console_login_help":{"zh-CN":"管理密钥仅保留在当前页面。点击后会复制密钥并打开私网控制台，再在控制台中粘贴登录。","en":"The management key stays only on this page. The action copies it, opens the private console, and you paste it there to sign in."},
    "extensions.console_login_key_placeholder":{"zh-CN":"粘贴管理密钥","en":"Paste management key"},
