(function (global) {
  ...
  var MESSAGES = {
    ...
    "extensions.push_configuration_copied":{"zh-CN":"Push 配置已复制。密钥已从此页面清除，请立即粘贴到 chatgpt2api。","en":"Push configuration was copied. The key was cleared from this page; paste it into chatgpt2api now."},
    ...
    "extensions.image_source_mode":{"zh-CN":"镜像来源","en":"Image source"},
    "extensions.image_preset_project":{"zh-CN":"1. GenBox 集成构建镜像","en":"1. GenBox integration build"},
    ...
    "extensions.image_preset_upstream":{"zh-CN":"2. 上游作者镜像","en":"2. Upstream author's image"},
    "extensions.image_preset_upstream_hint":{"zh-CN":"上游 PR 尚未合并，暂不能保证与 GenBox 联动；当前不可选。","en":"The upstream PR is not merged, so GenBox integration is not guaranteed; unavailable for now."},
    "extensions.image_preset_upstream_status":{"zh-CN":"上游 PR 尚未合并，当前不能用于 GenBox 联动部署。","en":"The upstream PR is not merged; this image cannot provide GenBox integration yet."},
    "extensions.image_preset_custom":{"zh-CN":"3. 自定义镜像","en":"3. Custom image"},
