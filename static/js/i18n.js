(function (global) {
  ...
  var MESSAGES = {
    ...
    "extensions.host_key_pairing_title":{"zh-CN":"用已登录的 SSH 终端快速验证","en":"Verify with an SSH terminal you already trust"},
    "extensions.host_key_pairing_help":{"zh-CN":"在你已经登录这台 VPS 的 SSH 窗口中运行下面这一行命令，再把输出粘贴回来。不需要在这里填写 SSH 密码。","en":"Run the one-line command in an SSH terminal you already trust, then paste its output here. No SSH password is entered here."},
    "extensions.host_key_pairing_start":{"zh-CN":"生成配对命令","en":"Generate pairing command"},
    ...
    "extensions.host_key_pairing_command":{"zh-CN":"在 SSH 窗口运行这一行","en":"Run this line in the SSH terminal"},
    "extensions.host_key_pairing_response":{"zh-CN":"粘贴命令输出","en":"Paste the command output"},
    "extensions.host_key_pairing_complete":{"zh-CN":"完成验证","en":"Complete verification"},
