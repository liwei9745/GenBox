(function (global) {
  ...
  MESSAGES['extensions.personal_access_title'] = {"zh-CN":"输入本次连接凭据","en":"Enter credentials for this session"};
  MESSAGES['extensions.personal_access_help'] = {"zh-CN":"凭据只用于这次检查，关闭页面后不会保留。","en":"Credentials are used only for this check and are not kept after the page closes."};
  MESSAGES['extensions.personal_check_continue'] = {"zh-CN":"检查并继续","en":"Check and continue"};
  MESSAGES['extensions.personal_ready_kicker'] = {"zh-CN":"检查完成","en":"Check complete"};
  MESSAGES['extensions.personal_ready_title'] = {"zh-CN":"服务器可以开始部署","en":"Your server is ready to deploy"};
  MESSAGES['extensions.personal_ready_help'] = {"zh-CN":"下一步会读取服务器环境并生成安全部署计划。","en":"Next, GenBox reads the server environment and prepares a safe deployment plan."};
  MESSAGES['extensions.personal_begin_planning'] = {"zh-CN":"准备部署方案","en":"Prepare deployment plan"};
