(function (global) {
  ...
  var MESSAGES = {
    ...
    "extensions.host_key_pairing_title":{"zh-CN":"在已登录的 SSH 终端里确认服务器","en":"Confirm the server in your trusted SSH terminal"},
    "extensions.host_key_pairing_help":{"zh-CN":"你不用填写密码，也不用理解命令。点击生成后，把命令复制到你已经登录的 VPS 终端，再把终端最后一行粘贴回来。","en":"You do not need to enter a password or understand the command. Generate it, copy it to your trusted VPS terminal, then paste the last line back here."},
    "extensions.host_key_pairing_start":{"zh-CN":"生成验证命令","en":"Generate verification command"},
    "extensions.host_key_pairing_manual":{"zh-CN":"改用手动核对","en":"Use manual verification"},
    "extensions.host_key_pairing_starting":{"zh-CN":"正在读取主机身份并生成一次性配对命令。","en":"Reading the host identity and creating a one-time pairing command."},
    "extensions.host_key_pairing_started":{"zh-CN":"请在已登录的 SSH 窗口运行命令，再粘贴输出。命令短时有效且只能使用一次。","en":"Run the command in your trusted SSH terminal and paste its output. It expires soon and works only once."},
    "extensions.host_key_pairing_command":{"zh-CN":"第 1 步：复制这条命令到 VPS 终端","en":"Step 1: Copy this command to the VPS terminal"},
    "extensions.host_key_pairing_response":{"zh-CN":"第 2 步：粘贴终端最后一行","en":"Step 2: Paste the last line from the terminal"},
    "extensions.host_key_pairing_copy":{"zh-CN":"复制命令","en":"Copy command"},
    "extensions.host_key_pairing_copied":{"zh-CN":"命令已复制。现在粘贴到 VPS 终端运行。","en":"Command copied. Paste it into the VPS terminal and run it."},
    "extensions.host_key_pairing_copy_manual":{"zh-CN":"复制失败，请选中命令后手动复制。","en":"Copy failed. Select the command and copy it manually."},
    "extensions.host_key_pairing_response_placeholder":{"zh-CN":"粘贴以 GENBOX-PAIR/1 开头的那一行","en":"Paste the line that starts with GENBOX-PAIR/1"},
    "extensions.host_key_pairing_step_command":{"zh-CN":"复制命令并在 VPS 终端运行","en":"Copy the command and run it in the VPS terminal"},
    "extensions.host_key_pairing_step_command_help":{"zh-CN":"只运行页面生成的这一行","en":"Run only the line generated here"},
    "extensions.host_key_pairing_step_response":{"zh-CN":"粘贴结果并提交","en":"Paste the result and submit"},
    "extensions.host_key_pairing_step_response_help":{"zh-CN":"只需粘贴以 GENBOX-PAIR/1 开头的最后一行","en":"Paste only the last line starting with GENBOX-PAIR/1"},
    "extensions.host_key_pairing_complete":{"zh-CN":"提交验证结果","en":"Submit verification result"},
    ...
    "extensions.host_key_pairing_expired":{"zh-CN":"验证已过期，临时信息已清除。请重新生成验证命令。","en":"The verification expired and temporary data was cleared. Generate a new command to try again."},
    "extensions.host_key_pairing_complete_success":{"zh-CN":"服务器身份已验证。现在可以输入 SSH 密码或私钥继续。","en":"The server identity is verified. Enter an SSH password or private key to continue."},
