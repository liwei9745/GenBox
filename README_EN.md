...
> [!IMPORTANT]
> **v2.6.10: Gemini official API compatibility repair.** Corrects native model testing and listing, keeps redacted quota diagnostics, and improves Provider enable controls and workflow loading performance. [Read the release notes](release-notes-v2.6.10.md)
