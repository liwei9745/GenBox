...
> [!IMPORTANT]
> **v2.6.9: Precision Edit compatibility fixes.** Preserves accepted GPT annotation editing, expansion and local cutout workflows; adds Gemini / Nano Banana connections with isolated presets, fixes double decompression and incorrect resolution-tier selection. Most Klong `nano-banana2` presets have passed user acceptance; unreliable extreme formats are marked experimental. [Read the release notes](release-notes-v2.6.9.md)
