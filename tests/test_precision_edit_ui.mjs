...
expect(js.includes("if (!event.shiftKey || !precisionEditSourceImageData) return;") && js.includes('wheelDelta < 0 ? 10 : -10') && js.includes('Number(event.deltaY) || Number(event.deltaX)'), 'Shift+wheel must support either event axis and adjust only a loaded canvas view zoom in fixed steps.');
