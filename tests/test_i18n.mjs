...
assert.equal(i18n.t('creator.precision_size_prompt_preset_append_hint'), '选择预设会替换当前构图说明；之后仍可自由编辑。');
...
assert.equal(i18n.t('creator.precision_output_size_strict_mismatch', { actual: '1376x768', target: '1536x864' }), '上游实际 1376x768，目标 1536x864；严格尺寸已失败。可改用裁切适配，不会自动重试付费请求。');
